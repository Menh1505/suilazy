      ...
      {files.map((file, index) => (
        ...
        >
          <div className="w-full">
            <h2 className="text-xl font-semibold text-white group-hover:text-purple-200 transition-colors truncate">
              {file.path}
            </h2>
            <p className="text-gray-400 mt-2 group-hover:text-purple-300 transition-colors truncate">
